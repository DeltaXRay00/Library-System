defmodule LibrarySystemWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use LibrarySystemWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import LibrarySystemWeb.ConnCase
    end
  end

  setup tags do
    LibrarySystem.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_credential(%{conn: conn}) do
    credential = LibrarySystem.CredentialsFixtures.credential_fixture()
  ...
  def log_in_credential(conn, credential) do
    token = LibrarySystem.Credentials.generate_credential_session_token(credential)
