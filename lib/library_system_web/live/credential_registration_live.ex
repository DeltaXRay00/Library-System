defmodule LibrarySystemWeb.CredentialRegistrationLive do
  use LibrarySystemWeb, :live_view

  alias LibrarySystem.Credentials
  alias LibrarySystem.Credentials.Credential
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      <.header class="text-center">
        ...
        <:subtitle>
          Already registered?
          <.link navigate={~p"/profiles/log_in"} class="font-semibold text-brand hover:underline">
            Log in
          </.link>
          to your account now.
        </:subtitle>
      ...
      <.simple_form
        ...
        action={~p"/profiles/log_in?_action=registered"}
        method="post"
      >
