defmodule LibrarySystem.Library do
  @moduledoc """
  The Library context.
  """
  ...
  def create_loan(attrs \\ %{}) do
    cleaned_attrs = clean_blank_datetime(attrs, ["returned_at"])

    %Loan{}
    |> Loan.changeset(cleaned_attrs)
    |> Repo.insert()
  end

  defp clean_blank_datetime(attrs, keys) do
