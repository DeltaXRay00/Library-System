defmodule LibrarySystem.Credentials do
  @moduledoc """
  ...
  alias LibrarySystem.Credentials.{Credential, CredentialToken, CredentialNotifier}
  ...
  ## Examples
      ...
      iex> deliver_credential_update_email_instructions(credential, current_email, &url(~p"/profiles/settings/confirm_email/#{&1}"))
      {:ok, %{to: ..., body: ...}}
  ...
  ## Examples
      ...
      iex> deliver_credential_confirmation_instructions(credential, &url(~p"/profiles/confirm/#{&1}"))
      {:ok, %{to: ..., body: ...}}

      iex> deliver_credential_confirmation_instructions(confirmed_credential, &url(~p"/profiles/confirm/#{&1}"))
  ...
  ## Examples
      ...
      iex> deliver_credential_reset_password_instructions(credential, &url(~p"/profiles/reset_password/#{&1}"))
      {:ok, %{to: ..., body: ...}}
