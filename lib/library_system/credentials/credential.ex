defmodule LibrarySystem.Credentials.Credential do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, LibrarySystem.Repo)
  ...
  @doc """
  A credential changeset for changing the password.
  ...
  """
  def valid_password?(%LibrarySystem.Credentials.Credential{hashed_password: hashed_password}, password)
